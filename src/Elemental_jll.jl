...
if VERSION < v"1.3.0-rc4"
    ...
    error("Unable to import Elemental_jll on Julia versions older than 1.3!")
end
...
artifacts = Pkg.Artifacts.load_artifacts_toml(artifacts_toml; pkg_uuid=UUID("c2e960f2-a21d-557e-aa36-859d46eed7e8"))
platforms = [Pkg.Artifacts.unpack_platform(e, "Elemental", artifacts_toml) for e in artifacts["Elemental"]]
...
if best_platform === nothing
    @debug("Unable to load Elemental; unsupported platform $(triplet(platform_key_abi()))")
else
